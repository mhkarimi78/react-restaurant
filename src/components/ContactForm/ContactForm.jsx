            ...
            <Form noValidate validated={validated} className="bg-dark text-light p-5 needs-validation" id="form" onSubmit={handleSubmit}>
                <Form.Group className="row mb-3">
                    <Col className="mb-3 mb-md-0" md={6}>
                        <Form.Label htmlFor="first-name" className="text-capitalize">نام</Form.Label>
                    ...
                    <Col md={6}>
                        <Form.Label htmlFor="last-name" className="text-capitalize">نام خانوادگی</Form.Label>
                ...
                <Form.Group className="row mb-3">
                    <Col className="mb-3 mb-md-0" md={6}>
                        <Form.Label htmlFor="phone-number" className="text-capitalize">شماره تلفن</Form.Label>
                    ...
                    <Col md={6}>
                        <Form.Label htmlFor="email" className="text-capitalize">آدرس ایمیل</Form.Label>
                ...
                <Form.Group className="row mb-3">
                    ...
                    <Col md={6}>
                        <Form.Label htmlFor="guests" className="text-capitalize">تعداد مهمانان</Form.Label>
                ...
                <Form.Group className="mb-3">
                    <Form.Label htmlFor="comments">نظرات</Form.Label>
